...
{	int i;
 ...
 cmnd();
		...
		for(i=0;i<=6;i++)	//how many numbers you want to take	
		{   
...
char key()
{
	...
	while(1)
	{
		...
		if(COL4 == 0){while(COL4 == 0);ROW=1;COL=4;break;}		
		ROW1 = 1; 
		...
		if(COL4 == 0){while(COL4 == 0);ROW=2;COL=4;break;}
		ROW1 = 1; 
		ROW2 = 1; 
		...
		if(COL4 == 0){while(COL4 == 0);ROW=3;COL=4;break;}
		ROW1 = 1; 
		ROW2 = 1; 
		ROW3 = 1;
		...
		if(COL4 == 0){while(COL4 == 0);ROW=4;COL=4;break;}
		delayms(500);
	}
